...
class Blocks {
    ...
    checkCollision(minCol, maxCol, maxRow) {
        ...
        if (logic.activeRow > maxRow) {
            logic.activeRow = maxRow;
            logic.hitFloor = true;
            // logic.spawnTetri();
        }
